...
@section('content')
  ...
  <p class="reasonLabel"><strong>Reason?</strong> 
    ...
    <button data-target="#viewMoodReasons" data-toggle="modal" class="btn btn-success btn-xs reasonButton"><i class="glyphicon glyphicon-eye-open"></i> View Submissions</button>
  </p>
